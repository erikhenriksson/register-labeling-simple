...
class TextSegmenter:
    def __init__(self, model_path: str, prob_threshold: float = 0.5, initial_min_words: int = 15, max_groups: int = 20):
    ...
    def evaluate_segmentation(self, blocks: List[str], breakpoints: List[int], 
                            cache: Dict[str, tuple]) -> Tuple[float, List[str], List[List[float]], List[List[float]]]:
    ...
    def process_document(self, text: str) -> Dict:
        ...
        return {
            ...
            "register_labels": [self.get_active_registers(probs) for probs in final_probs]
        }
