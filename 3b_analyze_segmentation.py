...
def plot_register_variances(
    doc_variances: Dict, seg_variances: Dict, output_path: str = "variances.png"
):
...
def print_variance_table(doc_variances: Dict, seg_variances: Dict):
    ...
    print(
        f"{'Register':<10} {'Doc Mean':<15} {'Seg Mean':<15} {'Doc Count':<10} {'Seg Count':<10}"
    )
    print("-" * 60)
    ...
    for reg in registers:
        ...
        print(
            f"{reg:<10} {doc_mean:<15.4f} {seg_mean:<15.4f} {doc_count:<10} {seg_count:<10}"
        )
